...
const MathematiqueTseco2022 = () => {
  ...
  const source = {
    uri: Platform.select({
      ios: 'bundle-assets://pdf/tsecoba2022.pdf',
      android: 'bundle-assets://pdf/tsecoba2022.pdf',
    }),
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Math du bac Tseco 2022</Text>
      </View>
...
export default MathematiqueTseco2022;
