...
const MathematiqueTseco2020 = () => {
  ...
  const source = {
    uri: Platform.select({
      ios: 'bundle-assets://pdf/tsecoba2020.pdf',
      android: 'bundle-assets://pdf/tsecoba2020.pdf',
    }),
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Math du bac Tseco 2020</Text>
      </View>
...
export default MathematiqueTseco2020;
