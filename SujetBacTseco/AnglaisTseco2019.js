...
const AnglaisTseco2019 = () => {
  ...
  const source = {
    uri: Platform.select({
      ios: 'bundle-assets://tll/TSS&TSECO2019Anglais.pdf',
      android: 'bundle-assets://tll/TSS&TSECO2019Anglais.pdf',
    }),
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Math du bac Tse 2019</Text>
      </View>
...
export default AnglaisTseco2019;
