...
const MathematiqueTss2020 = () => {
  ...
  const source = {
    uri: Platform.select({
      ios: 'bundle-assets://pdf/tssba2020.pdf',
      android: 'bundle-assets://pdf/tssba2020.pdf',
    }),
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Math du bac Tss 2020</Text>
      </View>
...
export default MathematiqueTss2020;
