...
const MathematiqueTss2019 = () => {
  ...
  const source = {
    uri: Platform.select({
      ios: 'bundle-assets://pdf/tssba2019.pdf',
      android: 'bundle-assets://pdf/tssba2019.pdf',
    }),
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Math du bac Tss 2019</Text>
      </View>
...
export default MathematiqueTss2019;
