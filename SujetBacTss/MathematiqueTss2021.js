...
const MathematiqueTss2021 = () => {
  ...
  const source = {
    uri: Platform.select({
      ios: 'bundle-assets://pdf/tssba2021.pdf',
      android: 'bundle-assets://pdf/tssba2021.pdf',
    }),
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Math du bac Tss 2021</Text>
      </View>
...
export default MathematiqueTss2021;
