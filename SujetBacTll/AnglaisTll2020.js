...
const AnglaisTll2020 = () => {
  ...
  const source = {
    uri: Platform.select({
      ios: 'bundle-assets://tll/tllbac2020.pdf',
      android: 'bundle-assets:/tll/tllbac2020.pdf',
    }),
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Anglais du bac Tll 2020</Text>
      </View>
