...
const AnglaisTll2019 = () => {
  ...
  const source = {
    uri: Platform.select({
      ios: 'bundle-assets://tll/Tllbac2019Anglais.pdf',
      android: 'bundle-assets://tll/Tllbac2019Anglais.pdf',
    }),
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Math du bac Tll 2019</Text>
      </View>
