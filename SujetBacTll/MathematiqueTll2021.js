...
const MathematiqueTll2021 = () => {
  ...
  const source = {
    uri: Platform.select({
      ios: 'bundle-assets://pdf/tllba2021.pdf',
      android: 'bundle-assets://pdf/tllba2021.pdf',
    }),
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Math du bac Tll 2021</Text>
      </View>
...
export default MathematiqueTll2021;
