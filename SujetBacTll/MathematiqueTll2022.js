...
const MathematiqueTll2022 = () => {
  ...
  const source = {
    uri: Platform.select({
      ios: 'bundle-assets://pdf/tllba2022.pdf',
      android: 'bundle-assets://pdf/tllba2022.pdf',
    }),
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Math du bac Tll 2022</Text>
      </View>
...
export default MathematiqueTll2022;
