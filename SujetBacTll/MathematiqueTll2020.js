...
const MathematiqueTll2020 = () => {
  ...
  const source = {
    uri: Platform.select({
      ios: 'bundle-assets://pdf/tllba2020.pdf',
      android: 'bundle-assets://pdf/tllba2020.pdf',
    }),
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Math du bac Tll 2020</Text>
      </View>
...
export default MathematiqueTll2020;
