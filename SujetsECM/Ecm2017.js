    ...
    <View style={[styles.container, dynamicStyles.container]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContainer}>
        ...
        <Text style={[styles.question, dynamicStyles.text]}>
          1) A. Qu’est-ce qu’une conscience professionnelle ? (2 points){'\n'}   B. En donne un exemple. (2 points)
        </Text>
        <Text style={[styles.question, dynamicStyles.text]}>
          2) En République du Mali, en rappelant les dates suivantes : (4 points){'\n'}   a) 20 Juin 1960{'\n'}   b) 20 Août 1960{'\n'}   c) 22 Septembre 1960{'\n'}   d) 20 Janvier 1961
        </Text>
        <Text style={[styles.question, dynamicStyles.text]}>
          3) Le conseil des Ministres : (4 points){'\n'}   a) Défini le{'\n'}   b) Quel est le rôle de ce conseil ?
        </Text>
        <Text style={[styles.question, dynamicStyles.text]}>
          4) Cite 4 objectifs visés par l’ONU. (4 points)
        </Text>
        <Text style={[styles.question, dynamicStyles.text]}>
          5) Lors des manifestations de colère à travers la ville, est-il bon ou non de saccager les biens publics ? Justifie ta réponse. (4 points)
        </Text>
      </ScrollView>
    </View>
  );
