...
const TLLLinguistique = () => {
  ...
  const images = [
    { title: 'Anglais', source: require('./../../../../Asset/ECM.png'), route: 'TLLAnglais' },
    { title: 'Philosophie', source: require('./../../../../Asset/ECM.png'), route: 'TLLPhilosophie' },
    { title: 'Français', source: require('./../../../../Asset/ECM.png'), route: 'TLLFrançais' },
    { title: 'Linguistique', source: require('./../../../../Asset/ECM.png'), route: 'TLLLinguistique' },
    { title: 'Arabe', source: require('./../../../../Asset/ECM.png'), route: 'TLLArabe' },
    { title: 'Mathématiques', source: require('./../../../../Asset/ECM.png'), route: 'TLLMathematique' },
