...
const Philosophie = () => {
  ...
  const [activeSubject, setActiveSubject] = useState('Philosophie'); // Default active subject
  ...
  return (
    <View style={[styles.container, isDarkMode ? darkStyles.container : lightStyles.container]}>
      ...
      <ScrollView vertical showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContainer}>
        <Text style={[styles.subtitles, { color: dynamicTextColor }]}>Philosophie pages TSE</Text>
        ...
        <View style={styles.imagecontainer}>
          <TouchableOpacity onPress={() => navigation.navigate('Mathpdf')}>
            <Image source={require('./../../../../Asset/TSEPHI24.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('Examalichoix')}>
            <Image source={require('./../../../../Asset/TSEPHI23.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('Examalichoix')}>
            <Image source={require('./../../../../Asset/TSEPHI22.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('Examalichoix')}>
            <Image source={require('./../../../../Asset/TSEPHI21.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('Examalichoix')}>
            <Image source={require('./../../../../Asset/TSEPHI20.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('Examalichoix')}>
            <Image source={require('./../../../../Asset/TSEPHI19.png')} style={styles.image} />
          </TouchableOpacity>
        </View>
      </ScrollView>
