...
const Biologies = () => {
  ...
  const images = [
    { title: 'Biologie et géologie', source: require('./../../../../Asset/MATH1.png'), route: 'Biologies' },
    { title: 'Physique', source: require('./../../../../Asset/MATH1.png'), route: 'Physique' },
    { title: 'Chimie', source: require('./../../../../Asset/MATH1.png'), route: 'Chimie' },
    { title: 'Anglais', source: require('./../../../../Asset/MATH1.png'), route: 'Anglaiss' },
    { title: 'Mathématiques', source: require('./../../../../Asset/MATH1.png'), route: 'Mathematique' },
    { title: 'Philosophie', source: require('./../../../../Asset/MATH1.png'), route: 'Philosophie' },
  ...
  return (
    <View style={[styles.container, isDarkMode ? darkStyles.container : lightStyles.container]}>
      ...
      <ScrollView vertical showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContainer}>
        <Text style={[styles.subtitles, { color: dynamicTextColor }]}>Biologie pages TSE</Text>
        ...
        <View style={styles.imagecontainer}>
          <TouchableOpacity onPress={() => navigation.navigate('Mathpdf')}>
            <Image source={require('./../../../../Asset/TSEBI24.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('Examalichoix')}>
            <Image source={require('./../../../../Asset/TSEBI23.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('Examalichoix')}>
            <Image source={require('./../../../../Asset/TSEBI21.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('Examalichoix')}>
            <Image source={require('./../../../../Asset/TSEBI22.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('Examalichoix')}>
            <Image source={require('./../../../../Asset/TSEBI20.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('Examalichoix')}>
            <Image source={require('./../../../../Asset/TSEBI19.png')} style={styles.image} />
          </TouchableOpacity>
        </View>
      </ScrollView>
