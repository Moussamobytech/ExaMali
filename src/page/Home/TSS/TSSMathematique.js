...
const TSSMathematique = () => {
  ...
  const images = [
    { title: 'Sociologie', source: require('./../../../../Asset/PHY.png'), route: 'TSSSociologie' },
    
    { title: 'Philosophie', source: require('./../../../../Asset/PHY.png'), route: 'TSSPhilosophie' },
    { title: 'Histoire', source: require('./../../../../Asset/PHY.png'), route: 'TSSHistoire' },
    { title: 'Anglais', source: require('./../../../../Asset/PHY.png'), route: 'TSSAnglais' },
    { title: 'Géographie', source: require('./../../../../Asset/PHY.png'), route: 'TSSGéographie' },
    { title: 'Mathématiques', source: require('./../../../../Asset/PHY.png'), route: 'TSSMathematique' },
