...
const TSSGéographie = () => {
  ...
  const [activeSubject, setActiveSubject] = useState('Géographie'); // Default active subject
  const [isDarkMode, setIsDarkMode] = useState(true); // Dark mode state

  const images = [
    { title: 'Philosophie', source: require('./../../../../Asset/HIST.png'), route: 'TSSPhilosophie' },
    { title: 'Histoire', source: require('./../../../../Asset/REDAC1.png'), route: 'TSSHistoire' },
    { title: 'Anglais', source: require('./../../../../Asset/PHY.png'), route: 'TSSAnglais' },
    { title: 'Géographie', source: require('./../../../../Asset/ANGLAIS1.png'), route: 'TSSGéographie' },
    { title: 'Mathématiques', source: require('./../../../../Asset/MATH1.png'), route: 'TSSMathematique' },
    { title: 'Sociologie', source: require('./../../../../Asset/ECM.png'), route: 'TSSSociologie' },
  ...
  return (
    <View style={[styles.container, isDarkMode ? darkStyles.container : lightStyles.container]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Text style={[styles.subtitles, { color: dynamicTextColor }]}>Géographie pages TSS</Text>
        ...
        <View style={styles.imagecontainer}>
          <TouchableOpacity onPress={() => navigation.navigate('#')}>
            <Image source={require('./../../../../Asset/TSSG24.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('#')}>
            <Image source={require('./../../../../Asset/TSSG23.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('#')}>
            <Image source={require('./../../../../Asset/TSSG22.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('#')}>
            <Image source={require('./../../../../Asset/TSSG21.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('#')}>
            <Image source={require('./../../../../Asset/TSSG20.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('#')}>
            <Image source={require('./../../../../Asset/TSSG19.png')} style={styles.image} />
          </TouchableOpacity>
        </View>
      </ScrollView>
