...
const TALFrançais = () => {
  ...
  const [activeSubject, setActiveSubject] = useState('Français'); // Default active subject
  ...
  return (
    <View style={[styles.container, isDarkMode ? darkStyles.container : lightStyles.container]}>
      ...
      <ScrollView vertical showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContainer}>
        <Text style={[styles.subtitles, { color: dynamicTextColor }]}>Français pages TAL</Text>
        ...
        <View style={styles.imagecontainer}>
          <TouchableOpacity onPress={() => navigation.navigate('#')}>
            <Image source={require('./../../../../Asset/TALF24.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('#')}>
            <Image source={require('./../../../../Asset/TALF23.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('#')}>
            <Image source={require('./../../../../Asset/TALF22.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('#')}>
            <Image source={require('./../../../../Asset/TALF21.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('#')}>
            <Image source={require('./../../../../Asset/TALF20.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('#')}>
            <Image source={require('./../../../../Asset/TALF19.png')} style={styles.image} />
          </TouchableOpacity>
        </View>
      </ScrollView>
