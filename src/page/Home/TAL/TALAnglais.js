...
const TALAnglais = () => {
  ...
  const images = [
    { title: 'Français', source: require('./../../../../Asset/HIST.png'), route: 'TALFrançais' },
    { title: 'Anglais', source: require('./../../../../Asset/HIST.png'), route: 'TALAnglais' },
    { title: 'Philosophie', source: require('./../../../../Asset/HIST.png'), route: 'TALPhilosophie' },
    { title: 'Linguistique', source: require('./../../../../Asset/HIST.png'), route: 'TALLinguistique' },
    { title: 'Art Dramatique', source: require('./../../../../Asset/HIST.png'), route: 'TALDramatique' },
    { title: 'Mathématiques', source: require('./../../../../Asset/HIST.png'), route: 'TALMathematique' },
    { title: 'Art Plastique', source: require('./../../../../Asset/HIST.png'), route: 'TALPlastique' }
