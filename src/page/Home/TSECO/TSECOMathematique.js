...
const TSECOMathematique = () => {
  const navigation = useNavigation();
  const [searchQuery, setSearchQuery] = useState('');
  const [searchResults, setSearchResults] = useState([]);
  const [isModalVisible, setModalVisible] = useState(false);
  const [activeSubject, setActiveSubject] = useState('Mathématique'); // Default active subject
  const [isDarkMode, setIsDarkMode] = useState(true); // Dark mode state

  const images = [
    { title: 'Mathématiques', source: require('./../../../../Asset/ANGLAIS1.png'), route: 'TSECOMathematique' },
    { title: 'Comptabilité', source: require('./../../../../Asset/ANGLAIS1.png'), route: 'TSECOComptabilite' },
    { title: 'Géographie', source: require('./../../../../Asset/ANGLAIS1.png'), route: 'TSECOGeographie' },
    { title: 'Anglais', source: require('./../../../../Asset/ANGLAIS1.png'), route: 'TSECOAnglais' },
    { title: 'Economie', source: require('./../../../../Asset/ANGLAIS1.png'), route: 'TSECOEconomie' },
    
    { title: 'Philosophie', source: require('./../../../../Asset/ANGLAIS1.png'), route: 'TSECOPhilosophie' },
  ];
  ...
  return (
    <View style={[styles.container, isDarkMode ? darkStyles.container : lightStyles.container]}>
      ...
      <ScrollView vertical showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContainer}>
        <Text style={[styles.subtitles, { color: dynamicTextColor }]}>Mathématique pages TSECO</Text>
...
export default TSECOMathematique;
