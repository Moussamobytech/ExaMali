...
const Math21 = ({ navigation }) => {
 ...
 <ScrollView vertical showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContainer}>
      {/* Content */}
      <Text style={styles.title}>Sujet de Mathématiques DEF 2021</Text>
      <Text style={styles.sectionTitle}>Épreuve de : Mathématiques DEF 2021</Text>

      {/* Section I - ALGEBRE */}
      <Text style={styles.subTitle}>I- ALGÈBRE (10pts)</Text>

      <View style={styles.exerciseContainer}>
        <Text style={styles.exerciseTitle}>Exercice 1 : (5pts)</Text>
      ...
      <View style={styles.exerciseContainer}>
        <Text style={styles.exerciseTitle}>Exercice 2 : (2pts)</Text>
        <Text style={[styles.exerciseText, dynamicStyles.text]}>
      ...
      <View style={styles.exerciseContainer}>
        <Text style={styles.exerciseTitle}>Problème : (3pts)</Text>
        <Text style={[styles.exerciseText, dynamicStyles.text]}>
      ...
      <Text style={styles.subTitle}>II- GÉOMÉTRIE : (10pts)</Text>
