    ...
    <View style={dynamicStyles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContainer}>
        ...
        <Text style={[styles.question, dynamicStyles.text]}>
          1) Citer et définir quatre anomalies de la vision ;
        </Text>
        <Text style={[styles.question, dynamicStyles.text]}>
          2) Quels sont les différents types de muscles ;
        </Text>
        <Text style={[styles.question, dynamicStyles.text]}>
          3) Explique : révolution cardiaque ; pouls ; automatisme cardiaque.
        </Text>
        <Text style={[styles.question, dynamicStyles.text]}>
          4) Donne la différence entre le plasma et le sérum ;
        </Text>
        <Text style={[styles.question, dynamicStyles.text]}>
          5) Nommer quatre maladies causées par le virus.
        </Text>
      </ScrollView>
    </View>
  );
