    ...
    <View style={dynamicStyles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContainer}>
        ...
        <Text style={[styles.question, dynamicStyles.text]}>
          1. Définis les termes suivants : la propriété, la démocratie, une République laïque. (6 points)
        </Text>
        <Text style={[styles.question, dynamicStyles.text]}>
          2. Pensez-vous que chaque citoyen, où qu’il soit, devrait aider les Forces Armées Maliennes à réussir leurs missions ? (1 point)
        </Text>
        <Text style={[styles.question, dynamicStyles.text]}>
          3. Cite les missions de l’Armée Malienne. (5 points)
        </Text>
        <Text style={[styles.question, dynamicStyles.text]}>
          4. Cite les institutions de la République du Mali. (8 points)
        </Text>
      </ScrollView>
    </View>
  );
