...
const Profil = () => {
  ...
  const images = [
    ...
    { title: 'Rédaction', source: require('./../../Asset/REDAC1.png'), route: 'Corriges' },
    { title: 'Anglais', source: require('./../../Asset/ANGLAIS1.png'), route: 'Corriges' },
    { title: 'Physique', source: require('./../../Asset/PHY.png'), route: 'Corriges' },
    { title: 'Éducation Civique et Morale', source: require('./../../Asset/ECM.png'), route: 'Corr blanchesiges' },
    { title: 'Histoire', source: require('./../../Asset/HIST.png'), route: 'Corriges' },
    { title: 'Biologie', source: require('./../../Asset/BIOS.png'), route: 'Corriges' },
    { title: 'Dictée', source: require('./../../Asset/DICTE.png'), route: 'Corriges' },
  ];
