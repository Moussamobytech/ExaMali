...
const Mathematique2023 = () => {
  ...
  const source = {
    uri: Platform.select({
      ios: 'bundle-assets://pdf/tseba2023.pdf',
      android: 'bundle-assets://pdf/tseba2023.pdf',
    }),
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Math du bac Tse 2023</Text>
      </View>
...
export default Mathematique2023;
