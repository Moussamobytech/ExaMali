...
const Mathematique2021 = () => {
  ...
  const source = {
    uri: Platform.select({
      ios: 'bundle-assets://pdf/tseba2021.pdf',
      android: 'bundle-assets://pdf/tseba2021.pdf',
    }),
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Math du bac Tse 2021</Text>
      </View>
...
export default Mathematique2021;
