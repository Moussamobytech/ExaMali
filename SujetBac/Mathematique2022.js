...
const Mathematique2022 = () => {
  ...
  const source = {
    uri: Platform.select({
      ios: 'bundle-assets://pdf/tseba2022.pdf',
      android: 'bundle-assets://pdf/tseba2022.pdf',
    }),
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Math du bac Tse 2022</Text>
      </View>
...
export default Mathematique2022;
