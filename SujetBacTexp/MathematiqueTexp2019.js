...
const MathematiqueTexp2019 = () => {
  ...
  const source = {
    uri: Platform.select({
      ios: 'bundle-assets://pdf/tsexpba2019.pdf',
      android: 'bundle-assets://pdf/tsexpba2019.pdf',
    }),
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Math du bac Texp 2019</Text>
      </View>
...
export default MathematiqueTexp2019;
