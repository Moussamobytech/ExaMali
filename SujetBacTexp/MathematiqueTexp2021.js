...
const MathematiqueTexp2021 = () => {
  ...
  const source = {
    uri: Platform.select({
      ios: 'bundle-assets://pdf/tsexpba2021.pdf',
      android: 'bundle-assets://pdf/tsexpba2021.pdf',
    }),
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Math du bac Texp 2021</Text>
      </View>
...
export default MathematiqueTexp2021;
