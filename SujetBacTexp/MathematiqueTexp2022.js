...
const MathematiqueTexp2022 = () => {
  ...
  const source = {
    uri: Platform.select({
      ios: 'bundle-assets://pdf/tsexpba2022.pdf',
      android: 'bundle-assets://pdf/tsexpba2022.pdf',
    }),
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Math du bac Texp 2022</Text>
      </View>
...
export default MathematiqueTexp2022;
