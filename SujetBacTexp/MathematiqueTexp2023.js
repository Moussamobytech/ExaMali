...
const MathematiqueTexp2023 = () => {
  ...
  const source = {
    uri: Platform.select({
      ios: 'bundle-assets://pdf/tsexpba2023.pdf',
      android: 'bundle-assets://pdf/tsexpba2023.pdf',
    }),
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Math du bac Texp 2023</Text>
      </View>
...
export default MathematiqueTexp2023;
