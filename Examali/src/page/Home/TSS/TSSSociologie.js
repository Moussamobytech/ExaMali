...
const TSSSociologie = () => {
  ...
  const [activeSubject, setActiveSubject] = useState('Sociologie'); // Default active subject
  ...
  return (
    <View style={[styles.container, isDarkMode ? darkStyles.container : lightStyles.container]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Text style={[styles.subtitles, { color: dynamicTextColor }]}>Sociologie pages TSS</Text>
