...
const Chimie = () => {
  ...
  const images = [
    ...
    { title: 'Physique', source: require('./../../../../Asset/REDAC1.png'), route: 'Redaction' },
    { title: 'Chimie', source: require('./../../../../Asset/ANGLAIS1.png'), route: 'Anglais' },
    { title: 'Anglais', source: require('./../../../../Asset/PHY.png'), route: 'Physique' },
    { title: 'Biologie et géologie', source: require('./../../../../Asset/ECM.png'), route: 'ECM' },
    { title: 'Philosophie', source: require('./../../../../Asset/HIST.png'), route: 'Histoire' },
