...
const Biologies = () => {
  ...
  const images = [
    { title: 'Biologie et géologie', source: require('./../../../../Asset/ECM.png'), route: 'ECM' },
    { title: 'Physique', source: require('./../../../../Asset/REDAC1.png'), route: 'Physique' },
    { title: 'Chimie', source: require('./../../../../Asset/ANGLAIS1.png'), route: 'Chimie' },
    { title: 'Anglais', source: require('./../../../../Asset/PHY.png'), route: 'Anglaiss' },
    { title: 'Mathématiques', source: require('./../../../../Asset/MATH1.png'), route: 'Mathématique' },
    { title: 'Philosophie', source: require('./../../../../Asset/HIST.png'), route: 'Philosophie' },
