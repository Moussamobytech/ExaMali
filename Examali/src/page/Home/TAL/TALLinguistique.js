...
const TALLinguistique = () => {
  const navigation = useNavigation();
  const [searchQuery, setSearchQuery] = useState('');
  const [searchResults, setSearchResults] = useState([]);
  const [isModalVisible, setModalVisible] = useState(false);
  const [activeSubject, setActiveSubject] = useState('Linguistique'); // Default active subject
  const [isDarkMode, setIsDarkMode] = useState(true); // Dark mode state

  const images = [
    { title: 'Français', source: require('./../../../../Asset/REDAC1.png'), route: 'TALFrançais' },
    { title: 'Anglais', source: require('./../../../../Asset/PHY.png'), route: 'TALAnglais' },
    { title: 'Philosophie', source: require('./../../../../Asset/HIST.png'), route: 'TALPhilosophie' },
    { title: 'Linguistique', source: require('./../../../../Asset/REDAC1.png'), route: 'TALLinguistique' },
    { title: 'Art Dramatique', source: require('./../../../../Asset/ANGLAIS1.png'), route: 'TALDramatique' },
    { title: 'Mathématiques', source: require('./../../../../Asset/MATH1.png'), route: 'TALMathematique' },
    { title: 'Art Plastique', source: require('./../../../../Asset/ECM.png'), route: 'TALPlastique' }
  ...
  return (
    <View style={[styles.container, isDarkMode ? darkStyles.container : lightStyles.container]}>
      ...
      <ScrollView vertical showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContainer}>
        <Text style={[styles.subtitles, { color: dynamicTextColor }]}>Linguistique pages TAL</Text>
        ...
        <View style={styles.imagecontainer}>
          <TouchableOpacity onPress={() => navigation.navigate('#')}>
            <Image source={require('./../../../../Asset/TALL24.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('#')}>
            <Image source={require('./../../../../Asset/TALL23.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('#')}>
            <Image source={require('./../../../../Asset/TALL22.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('#')}>
            <Image source={require('./../../../../Asset/TALL21.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('#')}>
            <Image source={require('./../../../../Asset/TALL20.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('#')}>
            <Image source={require('./../../../../Asset/TALL19.png')} style={styles.image} />
          </TouchableOpacity>
        </View>
      </ScrollView>
...
export default TALLinguistique;
