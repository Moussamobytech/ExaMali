...
const TLLLinguistique = () => {
  ...
  const images = [
    { title: 'Anglais', source: require('./../../../../Asset/PHY.png'), route: 'TLLAnglais' },
    { title: 'Philosophie', source: require('./../../../../Asset/HIST.png'), route: 'TLLPhilosophie' },
    { title: 'Français', source: require('./../../../../Asset/REDAC1.png'), route: 'TLLFrançais' },
    { title: 'Linguistique', source: require('./../../../../Asset/REDAC1.png'), route: 'TLLLinguistique' },
    { title: 'Arabe', source: require('./../../../../Asset/ANGLAIS1.png'), route: 'TLLArabe' },
    { title: 'Mathématiques', source: require('./../../../../Asset/MATH1.png'), route: 'TLLMathematique' },
    { title: 'Allemand', source: require('./../../../../Asset/ECM.png'), route: 'TLLAllemand' }
  ];
  ...
  return (
    <View style={[styles.container, isDarkMode ? darkStyles.container : lightStyles.container]}>
      ...
      <ScrollView vertical showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContainer}>
        <Text style={[styles.subtitles, { color: dynamicTextColor }]}>Linguistique pages TLL</Text>
...
export default TLLLinguistique;
