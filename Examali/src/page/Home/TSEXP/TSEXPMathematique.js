...
const TSEXPMathematique = () => {
  ...
  const images = [
    ...
    { title: 'Mathématiques', source: require('./../../../../Asset/REDAC1.png'), route: 'TSEXPMathematique' },
    { title: 'Philosophie', source: require('./../../../../Asset/REDAC1.png'), route: 'TSEXPPhilosophie' },
    { title: 'Physique', source: require('./../../../../Asset/REDAC1.png'), route: 'TSEXPPhysique' },
    { title: 'Chimie', source: require('./../../../../Asset/REDAC1.png'), route: 'TSEXPChimie' },
    { title: 'Biologie et géologie', source: require('./../../../../Asset/REDAC1.png'), route: 'TSEXPBiologie' },
    { title: 'Anglais', source: require('./../../../../Asset/REDAC1.png'), route: 'TSEXPAnglais' },
  ];
  ...
  return (
    <View style={[styles.container, isDarkMode ? darkStyles.container : lightStyles.container]}>
      ...
      <ScrollView vertical showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContainer}>
        <Text style={[styles.subtitles, { color: dynamicTextColor }]}>Mathématique pages TSEXP</Text>
        ...
        <View style={styles.imagecontainer}>
          <TouchableOpacity onPress={() => navigation.navigate('Mathpdf')}>
            <Image source={require('./../../../../Asset/tsexpma.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('Examalichoix')}>
            <Image source={require('./../../../../Asset/tsexpma1.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('Examalichoix')}>
            <Image source={require('./../../../../Asset/tsexpma2.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('Examalichoix')}>
            <Image source={require('./../../../../Asset/tsexpma3.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('Examalichoix')}>
            <Image source={require('./../../../../Asset/tsexpma4.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('Examalichoix')}>
            <Image source={require('./../../../../Asset/tsexpma5.png')} style={styles.image} />
          </TouchableOpacity>
        </View>
      </ScrollView>
...
export default TSEXPMathematique;
