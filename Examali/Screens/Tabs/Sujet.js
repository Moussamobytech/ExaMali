...
const Mathématique = () => {
  ...
  const images = [
    { title: 'Terminal science exact', source: require('./../../Asset/MATH1.png'), route: 'Mathematique' },
    { title: 'Terminal science expérimentale', source: require('./../../Asset/REDAC1.png'), route: 'TSEXPMathematique' },
    { title: 'Terminal science économique', source: require('./../../Asset/ANGLAIS1.png'), route: 'TSECOComptabilite' },
    { title: 'Terminal science sociale', source: require('./../../Asset/PHY.png'), route: 'TSSPhilosophie' },
    { title: 'Terminal lettre et langue', source: require('./../../Asset/ECM.png'), route: 'TSEXPBiologies' },
    { title: 'Terminal anglais et langue', source: require('./../../Asset/HIST.png'), route: 'Philosophie' },
  ...
  return (
    <View style={[styles.container, isDarkMode ? darkStyles.container : lightStyles.container]}>
      ...
      <ScrollView vertical showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContainer}>
        <Text style={[styles.subtitles, { color: dynamicTextColor }]}>Sujets pages</Text>
        ...
        <View style={styles.imagecontainer}>
          <TouchableOpacity onPress={() => navigation.navigate('Mathematique')}>
            <Image source={require('./../../Asset/TSE12.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('TSEXPMathematique')}>
            <Image source={require('./../../Asset/TSEXPS.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('TSECOComptabilite')}>
            <Image source={require('./../../Asset/TSECOS.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('TSSPhilosophie')}>
            <Image source={require('./../../Asset/TSSL.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('TLLAnglais')}>
            <Image source={require('./../../Asset/TLLL.png')} style={styles.image} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('TALFrançais')}>
            <Image source={require('./../../Asset/TALL.png')} style={styles.image} />
          </TouchableOpacity>
        </View>
      </ScrollView>
