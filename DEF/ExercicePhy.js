...
const ExercicePhy = () => {
  ...
  const source = {
    uri: Platform.select({
      ios: 'bundle-assets://pdf/phy-chimie.pdf',
      android: 'bundle-assets://DEF/phy-chimie.pdf',
    }),
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.headerTitle}>Mathématique exercice</Text>
      </View>
