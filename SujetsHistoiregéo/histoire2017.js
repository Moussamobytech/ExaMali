  ...
  return (
    <View style={dynamicStyles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Text style={[styles.header, dynamicStyles.header]}>DEF 2017 - Histoire et Géographie</Text>
        ...
        <Text style={[styles.paragraph, dynamicStyles.text]}>
          1) Explique les causes de la crise de 1929 et ses impacts sur l’économie mondiale. (5 pts)
        </Text>
        <Text style={[styles.paragraph, dynamicStyles.text]}>
          2) Décris les étapes de la formation de l’Union Africaine (UA) et ses objectifs. (5 pts)
        </Text>

        <Text style={[styles.sectionSubtitle, dynamicStyles.text]}>B - Géographie (10 pts)</Text>
        <Text style={[styles.paragraph, dynamicStyles.text]}>
          1) Décris les caractéristiques des ressources minières au Mali. (5 pts)
        </Text>
        <Text style={[styles.paragraph, dynamicStyles.text]}>
          2) Explique les causes et les conséquences de l’urbanisation rapide en Afrique de l’Ouest. (5 pts)
        </Text>
      </ScrollView>
    </View>
  );
