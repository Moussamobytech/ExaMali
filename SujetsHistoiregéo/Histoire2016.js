  ...
  return (
    <View style={dynamicStyles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Text style={[styles.header, dynamicStyles.header]}>DEF 2016 - Histoire et Géographie</Text>
        ...
        <Text style={[styles.paragraph, dynamicStyles.text]}>
          1) Explique les causes et les conséquences de la traite négrière atlantique. (5 pts)
        </Text>
        <Text style={[styles.paragraph, dynamicStyles.text]}>
          2) Décris le rôle de l’ONU dans le maintien de la paix mondiale. (5 pts)
        </Text>

        <Text style={[styles.sectionSubtitle, dynamicStyles.text]}>B - Géographie (10 pts)</Text>
        <Text style={[styles.paragraph, dynamicStyles.text]}>
          1) Décris les principaux fleuves du Mali et leur importance économique. (5 pts)
        </Text>
        <Text style={[styles.paragraph, dynamicStyles.text]}>
          2) Explique les impacts de la désertification au Sahel et les mesures pour y remédier. (5 pts)
        </Text>
